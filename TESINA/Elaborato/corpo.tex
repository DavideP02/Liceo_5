...
Come si può notare da ambo i grafici (\ref{lagr:par} e \ref{lagr:parzoom}), nell'intervallo compreso tra $P_1$ e $P_3$ l'interpolazione da una buona approssimazione della curva effettiva, sebbene non sia lo scopo esatto di questo strumento matematico.
...
Nonostante questi due metodi siano sostanzialmente diversi nella forma, il loro risultato sarà necessariamente la stessa. Si dimostra\citazione{int:unimi}{Esistenza e unicità del polinomio interpolante}, infatti, l'unicità del polinomio interpolante
