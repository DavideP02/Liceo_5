...
\addto\captionsitalian{\renewcommand{\listfigurename}{Figure e tabelle}} % modificare nome ``Elenco delle figure''
\def\table{\def\figurename{Table}\figure} % unire lista delle figure e delle tabelle
