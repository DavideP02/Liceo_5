...
\poemlines{3}
\setverselinenums{46}{48}
E io ch’al fine\mat{compimento: vedere Dio} di tutt’i disii\\
appropinquava, sì com’io dovea,\\
l’ardor del desiderio in me finii.\mat{lo portai al culmine}\\!
Bernardo m’accennava, e sorridea,\\
perch’io guardassi suso; ma io era\\
già per me stesso tal qual ei volea:\\!
ché la mia vista, venendo sincera,\mat{diventando limpida}\\
e più e più intrava per lo raggio\\
de l’alta luce che da sé è vera.\mat{luce divina}\\!
Da quinci innanzi il mio veder fu maggio\\
che ‘l parlar mostra, ch’a tal vista cede,\\
e cede la memoria\mat{questi versi ci riportano all'inizio della cantica, quando Dante ci dice che sarà difficile narrare le cose viste, anche per i limiti della memoria umana} a tanto oltraggio.\mat{eccesso, ``che passa il limite'', senza accezione negativa}\\!
Qual è colui che sognando vede,\\
che dopo ‘l sogno la passione impressa\\
rimane, e l’altro a la mente non riede,\\!
cotal son io\mat{Dante narratore}, ché quasi tutta cessa\\
mia visione, e ancor mi distilla\mat{si insidia goccia a goccia}\\
nel core il dolce che nacque da essa.\\!
Così la neve al sol si disigilla\mat{così la memoria è venuta meno};\\
così al vento ne le foglie levi\\
si perdea la sentenza di Sibilla.\mat{ella scriveva le sentenze sulle foglie, e poi arrivava un vento che le scompigliava tutte (riferimento al mito)}\\!
O somma luce\mat{invocazione direttamente a Dio} che tanto ti levi\\
da’ concetti mortali\mat{possibilità di comprensione degli uomini}, a la mia mente\\
...
se li occhi miei da lui fossero aversi.\mat{allontanato}\\!
E’\mat{``egli'' sovrabbondante} mi ricorda ch’io fui più ardito\mat{coraggioso}\\
per questo a sostener, tanto ch’i’ giunsi\mat{congiunsi}\\
l’aspetto mio\mat{il mio sgauardo} col valore infinito.\\!
Oh abbondante grazia ond’io presunsi\\
ficcar lo viso per la luce etterna,\\
tanto che la veduta vi consunsi!\\!
Nel suo profondo vidi che s’interna\\
legato con amore in un volume,\\
ciò che per l’universo si squaderna:\mat{Dante vuole comunicare l'idea dell'unità: il mondo e l'universo sono le varie parti di un quaderno, mentre Dio è il quaderno rilegato}\\!
sustanze e accidenti e lor costume,\\
quasi conflati insieme, per tal modo\\
che ciò ch’i’ dico è un semplice lume.\mat{pallida immagine}\\!
La forma universal di questo nodo\\
credo ch’i’ vidi, perché più di largo,\\
dicendo questo, mi sento ch’i’ godo.\\!
Un punto solo m’è maggior letargo\\
che venticinque secoli a la ‘mpresa,\\
che fé Nettuno ammirar l’ombra d’Argo.\mat{Dante cerca di far capire la grandezza del suo oblio}\\!
...
però\mat{per il fatto che} che ‘l ben, ch’è del volere obietto\mat{oggetto del desiderio},\\
tutto s’accoglie in lei, e fuor di quella\\
è defettivo ciò ch’è lì perfetto.\\!
Omai sarà più corta\mat{inconsistente} mia favella,\\
...
mutandom’io, a me si travagliava.\mat{perché diventava maggiore la sua capacità di guardarla}\\!
Ne la profonda e chiara sussistenza\\
de l’alto lume parvermi\mat{inizio della descrizione di Dio} tre\mat{immagine della trinità} giri\mat{cerchi}\\
di tre colori e d’una contenenza\mat{dimensione};\\!
e l’un da l’altro come iri da iri\\
parea reflesso, e ‘l terzo parea foco\\
che quinci e quindi igualmente si spiri.\\!
Oh quanto è corto il dire e come fioco\\
al mio concetto!\mat{tema dell'ineffabile} e questo, a quel ch’i’ vidi,\\
è tanto, che non basta a dicer ‘poco’.\mat{eufemismo}\\!
O luce etterna che sola in te sidi,\\
sola t’intendi, e da te intelletta\\
e intendente te ami e arridi!\mat{gioco di parole Dantesco: Dio basta a se stesso}\\!
Quella circulazion che sì concetta\mat{compresa}\\
pareva in te come lume reflesso,\\
da li occhi miei alquanto circunspetta,\\!
dentro da sé, del suo colore stesso,\\
mi parve pinta de la nostra effige\mat{immagine di Cristo}:\\
per che ‘l mio viso in lei tutto era messo.\\!
Qual è ‘l geomètra che tutto s’affige\\
per misurar lo cerchio\mat{quadratura del cerchio}, e non ritrova,\\
pensando, quel principio ond’elli indige,\\!
tal era io a quella vista nova\mat{Dante usa questa similitudine perché non riesce a trovare un legame e a far combaciare l’immagine che sta vedendo con una immagine umana, sebbene ci sia qualcosa in quella immagine che lo riporta all’effige degli uomini}:\\
veder voleva come si convenne\\
l’imago al cerchio e come vi s’indova\mat{neologismo mai più ripreso: trovare posto};\\!
ma non eran da ciò le proprie penne\mat{penne delle ali, che permettono di volare (produrre poesia): diventano simbolo per le proprietà intellettuali}:\\
se non che la mia mente fu percossa\\
da un fulgore in che sua voglia venne.\\!
A l’alta fantasia qui mancò possa;\\
ma già volgeva il mio disio e ‘l velle,\\
sì come rota ch’igualmente è mossa,\\!
l’amor che move il sole e l’altre stelle.\mat{in questo momento Dante è accomunato alle anime del paradiso}\\!
\end{verse}
